...
(0, _react2.storiesOf)("Forms/SelectInput", module).add("Default", function () {
  var Example =
  /*#__PURE__*/
  ...
  function (_React$Component2) {
    ...
    function Example() {
      ...
      _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(Example)).call.apply(_getPrototypeOf3, [this].concat(args)));
  ...
  return _react.default.createElement(Example, null);
}).add("With loading spinner", function () {
  var Example =
  /*#__PURE__*/
