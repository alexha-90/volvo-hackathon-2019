...
function Button(_ref3) {
  ...
  return _react.default.createElement(_click.Click, _extends({
  ...
  }), loading && _react.default.createElement(_block.Block, {
    extend: {
      position: "absolute",
      margin: "0 auto",
      top: 10
    ...
    color: "auto",
    size: 30
  })), loading ? _react.default.createElement(_inline.Inline, {
    extend: {
      visibility: "hidden"
    }
    ...
    iconAfter: iconAfter,
    arrow: arrow
  }, children)) : _react.default.createElement(InnerButton, {
    iconBefore: iconBefore,
    iconAfter: iconAfter,
    arrow: arrow
  }, children));
...
var InnerButton = function InnerButton(_ref4) {
  var children = _ref4.children,
      ...
      arrow = _ref4.arrow;
  return _react.default.createElement(_react.default.Fragment, null, iconBefore && _react.default.createElement(_inline.Inline, {
    extend: {
      marginRight: 12,
      position: "relative",
      bottom: "-3px"
    ...
    direction: arrow
  })), iconAfter && _react.default.createElement(_inline.Inline, {
    extend: {
      marginLeft: 12,
      position: "relative",
      bottom: "-3px"
...
Button.propTypes = {
  ...
  intent: _propTypes.default.oneOf(["primary", "primary-light", "secondary", "destructive"]),
